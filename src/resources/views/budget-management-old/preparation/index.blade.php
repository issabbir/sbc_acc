...
@section('footer-script')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#initialization_period, #fiscal_year").on('change', function () {
                resetBudgetTable();
            ...
            $("#load_budget_detail").on('click', function () {
                ...
                if (nullEmptyUndefinedChecked(fiscalYear.val())) {
                    ...
                    getBudgetDetails(fiscalYear.val(), department.val(), iniPeriod.val(), loadFor)
                }
                //getBudgetDetails(fiscalYear.val(),department.val(),iniDate.val())
            });

            getBudgetDetails = function (fiscal_year, dept_id, ini_period_id, loadFor) {
                var request = $.ajax({
                    url: APP_URL + '/budget-management/ajax/initial-budget-details',
                    method: 'GET',
                    data: {fiscal_year: fiscal_year, dept_id: dept_id, ini_period_id: ini_period_id, load_for: loadFor}
                });
