            ...
            <div class="card">
                <div class="row">
                    <div class="card-header d-flex justify-content-between align-items-center pb-0">
                        <h4 class="card-title ml-1">Budget Head Setup</h4>
                ...
                <div class="card-body pt-0">
                                        ...
                                        <ul id="tree" class="pl-0">
                                            @forelse($budget_list as $option)
                                                <li data-tree-branch="{{ $option->node_path }}" class="text-dark lirow">
                                                    ...
                                                    <a target="_blank" href="{{route('budget-head.budget-head-edit', [$option->budget_head_id])}}" style="float: right"><i class="bx bx-edit cursor-pointer"></i></a>
                                                    <a target="_blank" href="{{route('budget-head.budget-head-view', [$option->budget_head_id]) }}" style="float: right"><i class="bx bx-show cursor-pointer"></i></a>
                                                </li>
                                            @empty
                    ...
                    @include('budget-management.budget-account-setup.search_list')
...
@section('footer-script')
    <script type="text/javascript">
        ...
        var oTable = $('#budget-head-search-list').DataTable({
            ...
            ajax: {
                url: APP_URL + '/budget-management/ajax/budget-head-code-search-list',
                type: 'POST',
                headers: {
