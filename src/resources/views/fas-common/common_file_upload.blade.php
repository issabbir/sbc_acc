                    ...
                    @forelse($data['insertedData']->attachments as $index=>$attachment)
                        ...
                        <div class="row rowCounter dynamicRows mt-1">
                            ...
                            <div class="col-md-7">
                                <div class="row">
                                    <div class="col-md-8">
                                        <input readonly maxlength="100" class="form-control attachmentDescription"
                                               type="text"
                                    ...
                                    @if((\Illuminate\Support\Facades\Auth::user()->user_id == $attachment->insert_by) && !isset($data['insertedData']->hide_delete))
