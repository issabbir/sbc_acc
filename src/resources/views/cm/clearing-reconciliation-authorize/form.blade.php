<div class="card">
    <div class="card-body">
        <h5 style="text-decoration: underline">Clearing Reconciliation Authorize</h5>
        <div class="row">
                    ...
                    <form method="POST" id="reconciliation-search-form">
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex justify-content-end ">
                                <div class="mb-1">
                                    <button type="submit" class="btn btn-primary mb-1 btn-sm"><i class="bx bx-search font-size-small"></i><span class="align-middle ">Search</span></button>
                                    <button type="button" class="btn btn-secondary mb-1 btn-sm" id="reset"><i class="bx bx-reset font-size-small"></i><span class="align-middle">Reset</span></button>
                                    <button type="reset" class="btn btn-secondary mb-1 d-none" id="resetMain"></button>
                                </div>
                            </div>
                        </div>
                    {{--<div class="row">
                        ...
                        {{--<div class="row">
                            <div class="col-md-10 d-flex justify-content-end pl-0 ">
                                <div class="mt-2">
        ...
        <form id="outward_clearing_form">
            <div class="row">
                {{--<fieldset class="border p-2 col-md-12" id="outward_clearing_post_area">
                    <legend class="w-auto" style="font-size: 15px;">Clearing Reconciliation Authorize
                    </legend>--}}
                    <input type="hidden" value="" name="clearing_id" id="clearing_id">
                    <input type="hidden" value="" name="map_id_v" id="map_id_v">
                ...
                <div class="row mt-2">
                    <div class="col-md-12 d-flex">
                        {{--@if (isset($wkRefStatus) &&  $wkRefStatus == \App\Enums\ApprovalStatus::PENDING)--}}
                            <input type="hidden" name="approve_reject_value" id="approve_reject_value" value=""/>
                            <button disabled type="button" class="btn btn-sm btn-primary approve-reject-btn mr-1" name="authorize"
                            ...
                            <button disabled type="button" class="btn btn-sm btn-danger approve-reject-btn mr-1" name="decline"
                                    id="approve_reject_btn" value="{{ App\Enums\ApprovalStatus::REJECT }}"><i
                                    class="bx bxs-x font-size-small"></i><span class="align-middle ml-25"></span>Decline
                            </button>
                        {{--@endif--}}
                        {{--<a href="{{route('invoice-bill-payment-authorize.index')}}" class="btn btn-sm btn-dark" id="authorizer_back_btn"><i
            ...
            {{--<div class="row mt-1">
                <div class="col-md-2"><label for="authorizer" class="required">Authorizer </label></div>
                <div class="col-md-3 form-group pl-0">
                    <input type="text" id="authorizer" class="form-control form-control-sm" name="authorizer" required/>
                </div>
                <div class="col-md-2"><label for="comment" class="">Comment </label></div>
                <div class="col-md-3 form-group pl-0">
                    <input type="text" id="comment" class="form-control form-control-sm" name="comment" />
            ...
            {{--<div class="row mt-1">
                <div class="col-md-5">
                    <button type="submit" class="btn btn-success" id="outward_clearing_form_submit_btn"><i
