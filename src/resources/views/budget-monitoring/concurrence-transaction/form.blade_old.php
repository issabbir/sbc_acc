    ...
    <div class="row">
            ...
            <fieldset class="border pl-1 pr-1">
                ...
                <div class="form-group row" style="margin-bottom:8px">
                    ...
                    <select required name="fiscal_year"
                            class="form-control form-control-sm col-sm-3 required make-readonly-bg"
                            id="fiscal_year">
                ...
                <div class="form-group row" style="margin-bottom:8px">
                    ...
                    <div class="col-sm-8 pl-0">
                        <input readonly tabindex="-1" name="budget_head_name" class="form-control form-control-sm"
                               value="" type="text"
                               id="budget_head_name">
                    </div>
                </div>
                <div class="form-group row" style="margin-bottom:8px">
                    ...
                    <div class="col-sm-8 pl-0">
                        <input readonly tabindex="-1" name="budget_sub_category" class="form-control form-control-sm"
                               value=""
                               type="text"
                ...
                <div class="form-group row" style="margin-bottom:8px">
                    ...
                    <div class="col-sm-8 pl-0">
                        <input readonly tabindex="-1" name="budget_category" class="form-control form-control-sm"
                               value="" type="text"
                               id="budget_category">
                    </div>
                </div>
                <div class="form-group row" style="margin-bottom:8px">
                    ...
                    <div class="col-sm-8 pl-0">
                        <input readonly tabindex="-1" name="budget_type" class="form-control form-control-sm" value=""
                               type="text"
                               id="budget_type">
                    </div>
                </div>
        ...
        <div class="col-sm-6">
            <fieldset class="border pl-1 pr-1" style="height: 100%;">
                ...
                <div class="form-group row" style="margin-bottom:8px">
                    <label for="utilized_amount" class="col-form-label col-sm-5">{{--Utilized Amount--}}Booked Amount</label>
                    <div class="col-sm-5">
    ...
    <div class="row">
        <div class="col-sm-6 pr-0">
            <fieldset class="border pl-1 pr-1" style="height: 100%">
                ...
                <div class="form-group row" style="margin-bottom:8px">
                    <label for="bill_section" class="col-sm-4 col-form-label">Bill Section</label>
                    <div class="col-sm-8 pl-0">
                ...
                <div class="form-group row" style="margin-bottom:8px">
                    <label for="bill_register" class="col-sm-4 col-form-label">Bill Register</label>
                    <div class="col-sm-8 pl-0">
                ...
                <div class="form-group row" style="margin-bottom:8px">
                    <label for="voucher_no" class="col-sm-4 col-form-label required">Voucher No</label>
                    <div class="col-sm-8 pl-0">
                        <input maxlength="100" name="voucher_no" type="text" required
    ...
    <div class="row">
        <div class="col-sm-12">
            <fieldset class="border pl-1 pr-1">
                ...
                <div class="form-group row">
                    <label class="col-form-label col-md-2" for="vendor_id">Party/Vendor ID</label>
                    <div class="col-md-2 pl-0">
                        <input name="vendor_id" class="form-control form-control-sm " value=""
                               type="number"
                               id="vendor_id"
                               maxlength="10"
                    ...
                    <div class="col-md-2 pl-0">
                        <button class="btn btn-sm btn-primary vendorIdSearch" id="vendor_search" type="button"
                                tabindex="-1"><i class="bx bx-search font-size-small"></i><span
                                class="align-middle ml-25">Search</span>
                        </button>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="form-group row" style="margin-bottom:8px">
                            ...
                            <div class="col-sm-4 pl-0">
                                <input name="contract_id" class="form-control form-control-sm bg-info bg-accent-2"
                                       value="" type="text" readonly tabindex="-1"
                                       id="contract_id">
                            </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row" style="margin-bottom:8px">
                            <label for="subject" class="col-form-label col-sm-3 pr-0">Subject</label>
                            <div class="col-sm-9 pl-0">
                                <input name="subject" class="form-control form-control-sm" value="" type="text"
                                       id="subject"
                                       maxlength="200">
                            </div>
                        </div>
                        ...
                        <div class="form-group row" style="margin-bottom:8px">
                            ...
                            <div class="col-sm-4 pl-0">
                                ...
                                <input required name="booking_amount" class="form-control form-control-sm text-right" value=""
                                       type="text" {{--step="0.1"--}} oninput="maxLengthValid(this);this.value = this.value.match(/\d+\.?\d{0,2}/);"
                                       id="booking_amount"
                                       maxlength="20">
                            </div>
                        </div>
