...
<form id="concurrence_form" action="#" method="post" enctype="multipart/form-data">
        ...
        <div class="col-sm-6 pr-0">
            <fieldset class="border pl-1 pr-1" style="height: 100%">
                ...
                <div class="form-group row" style="margin-bottom:8px">
                    ...
                    <div class="col-sm-9">
                        <select required
                                data-bill-register-id="{{old('bill_register', isset($data['insertedData']) ? $data['insertedData']->bill_reg_id : '' )}}"
                ...
                <div class="row">
                    ...
                    <label for="transaction_period" class="required col-form-label col-sm-2 pl-0 pr-0">Posting Period</label>
                    <div class="col-sm-3">
                ...
                <div class="row ">
                    ...
                    <div class="input-group mb-1 date transaction_date col-sm-4"
                        id="transaction_date"
                ...
                <div class="row">
                    ...
                    <div class="input-group mb-2 date document_date col-md-4"
                         id="document_date"
                         data-target-input="nearest">
                ...
                <div class="form-group row" style="margin-bottom:8px">
                    <label for="document_no" class="col-sm-3 col-form-label {{isset($isRequired) ? $isRequired['document_required'] : ''}}">Document No</label>
                    <div class="col-sm-9">
                        <input maxlength="100" name="document_no" type="text" tabindex="6" {{isset($isRequired) ? $isRequired['document_required'] : ''}}
                    ...
                    <fieldset class="border pl-1 pr-1">
                        ...
                        <div class="form-group row" style="margin-bottom:8px">
                            <label for="department" class="col-form-label col-sm-3 required pr-0">Dept/Cost
                                Center</label>
                            <div class="col-sm-9 {{isset($data['insertedData']) ? 'make-select2-readonly-bg' : ''}}">
                ...
                <div class="col-md-12 pr-0">
                    <fieldset class="border pl-1 pr-1">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row" style="margin-bottom:8px">
                                    <label for="fill_no" class="col-sm-3 col-form-label">File No</label>
                                    <div class="col-sm-4">
                                        <input maxlength="50" name="fill_no" type="text"
                                               value="{{old('fill_no',isset($data['insertedData']) ? $data['insertedData']->file_no  : '')}}"
                                               class="required form-control form-control-sm"
                                               id="fill_no">
                                    </div>
                                    <label for="page_no" class=" col-sm-2 col-form-label">Page No</label>
                                    <div class="col-sm-3">
                                        <input maxlength="10" name="page_no" type="number"
                                               oninput="maxLengthValid(this)"
                                               value="{{old('page_no',isset($data['insertedData']) ? $data['insertedData']->page_no  : '')}}"
                                               class="required form-control form-control-sm"
                                               id="page_no">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group row" style="margin-bottom:8px">
                                    <label for="memo_no" class=" col-sm-3 col-form-label">Memo No</label>
                                    <div class="col-sm-4">
                                        <input maxlength="50" name="memo_no" type="text"
                                               value="{{old('memo_no',isset($data['insertedData']) ? $data['insertedData']->memo_no  : '')}}"
                                               class="required form-control form-control-sm"
                                               id="memo_no">
                                    </div>
                                    <label for="memo_date_field" class="col-sm-2 pr-0 col-form-label">Memo. Date</label>
                                    <div class="input-group date memo_date col-sm-3"
                                         id="memo_date"
                                         data-target-input="nearest">
                                        <input type="text" autocomplete="off" onkeydown="return false"
                                               ...
                                               data-toggle="datetimepicker"
                                               value="{{ old('memo_date', isset($data['insertedData']) ? \App\Helpers\HelperClass::dateConvert($data['insertedData']->memo_date)  : '') }}"
                                               data-predefined-date="{{ old('memo_date', isset($data['insertedData']) ? \App\Helpers\HelperClass::dateConvert($data['insertedData']->memo_date)  : '') }}"
                                               placeholder="DD-MM-YYYY">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group row" style="margin-bottom:8px">
                                    <label for="est_amount" class=" col-sm-3 col-form-label">Est. Amount</label>
                                    <div class="col-sm-4">
                                        <input maxlength="20" name="est_amount" tabindex="-1" autocomplete="off"
                                               ...
                                               value="{{old('est_amount',isset($data['insertedData']) ? $data['insertedData']->estimate_amount  : '')}}"
                                               class=" form-control form-control-sm text-right"
                                               id="est_amount">
                                    </div>
                                    <label for="est_date_field" class="col-sm-2 col-form-label">Est. Date</label>
                                    <div class="input-group date est_date col-sm-3"
                                         id="est_date"
                                         data-target-input="nearest">
                                        <input type="text" autocomplete="off" onkeydown="return false"
                                               name="est_date"
                                               ...
                                               data-toggle="datetimepicker"
                                               value="{{ old('est_date', isset($data['insertedData']) ? \App\Helpers\HelperClass::dateConvert($data['insertedData']->estimate_date)  : '') }}"
                                               data-predefined-date="{{ old('est_date', isset($data['insertedData']) ? \App\Helpers\HelperClass::dateConvert($data['insertedData']->estimate_date)  : '') }}"
                                               placeholder="DD-MM-YYYY">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <textarea readonly rows="2" class="form-control form-control-sm"
                                              id="est_amount_word"
                                              tabindex="-1"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12 mb-1">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea maxlength="500" name="remarks" class="required form-control form-control-sm"id="remarks">{{ old('remarks', isset($data['insertedData']) ? $data['insertedData']->remarks : '') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12 pr-0">
                    <fieldset class="border pl-1 pr-1">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row" style="margin-bottom:8px">
                                    <label for="fill_no" class="col-sm-5 col-form-label">File No</label>
                                ...
                                <div class="form-group row" style="margin-bottom:8px">
                                    <label for="memo_no" class=" col-sm-5 col-form-label">Memo No</label>
                                    <div class="col-sm-7 pl-0 pr-0">
                                        <input maxlength="50" name="memo_no" type="text"
                                               value="{{old('memo_no',isset($data['insertedData']) ? $data['insertedData']->memo_no  : '')}}"
                                               class="required form-control form-control-sm"
                                ...
                                <div class="form-group row" style="margin-bottom:8px">
                                    <label for="est_amount" class=" col-sm-5 col-form-label">Est. Amount</label>
                                    <div class="col-sm-7 pl-0 pr-0">
                                        <input maxlength="20" name="est_amount" tabindex="-1" autocomplete="off"
                                               type="text"
                                               oninput="maxLengthValid(this);this.value = this.value.match(/\d+\.?\d{0,2}/);"
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row" style="margin-bottom:8px">
                                    <label for="est_date_field" class=" col-sm-4 col-form-label">Est. Date</label>
                                    <div class="input-group date est_date col-sm-6"
                                         id="est_date"
                                         data-target-input="nearest">
                                        <input type="text" autocomplete="off" onkeydown="return false"
                                               name="est_date"
                    ...
                    <textarea maxlength="500" name="remarks" class="required form-control form-control-sm "
                              id="remarks">{{ old('remarks', isset($data['insertedData']) ? $data['insertedData']->remarks : '') }}</textarea>
                            </div>
                        </div>
                    </fieldset>
                </div>
                ...
                <div class="col-sm-12">
                    <fieldset class="border pl-1 pr-1">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group row" style="margin-bottom:8px">
                                    ...
                                    <div class="col-sm-5">
                                        <input name="contract_id"
                                               ...
                                               value="{{ old('contract_id', isset($data['insertedData']) ?  $data['insertedData']->contract_id : '') }}"
                            ...
                            <div class="col-md-12">
                                <div class="form-group row" style="margin-bottom:8px">
                                    <label for="tender_proposal_type" class="required col-sm-4 col-form-label">Tender
                                        Type</label>
                                    <div class="col-sm-8">
                                        <select name="tender_proposal_type" tabindex="9" required
                                                class="form-control form-control-sm select2 "
                                                id="tender_proposal_type">
                                            <option value="">&lt;Select&gt;</option>
                                            @foreach( $data['lTenderType'] as $value)
                                                <option
                                                    {{old('tender_proposal_type', isset($data['insertedData']) ? ($data['insertedData']->tender_type_id == $value->tender_type_id) ? 'selected' : '' : '' )}} value="{{$value->tender_type_id}}">{{ $value->tender_type_name}}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group row" style="margin-bottom:8px">
                                    <label class="col-form-label col-md-4" for="vendor_id">Party/Vendor ID</label>
                                    <div class="col-md-5">
                                        <input name="vendor_id" class="form-control form-control-sm "
                                               value="{{ old('vendor_id', isset($data['insertedData']) ?  $data['insertedData']->vendor_id : '') }}"
                                               type="number" tabindex="11"
                                               id="vendor_id"
                                               maxlength="10"
                            ...
                            <div class="col-md-12">
                                <div class="form-group row" style="margin-bottom:8px">
                                    <label class="col-form-label col-md-4 " for="vendor_name">Party/Vendor
                                        Name</label>
                                    <div class="col-md-8">
                                        <textarea type="text" class="form-control form-control-sm"
                                                  id="vendor_name" rows="2"
                                                  name="vendor_name"
                                                  readonly>{{ old('vendor_name', isset($data['insertedData']) ?  $data['insertedData']->vendor_name : '') }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group row" style="margin-bottom:8px">
                                    <label for="tender_proposal_no" class="col-form-label col-sm-4">Tender/Prop.
                                        No</label>
                                    <div class="col-sm-4">
                                        <input name="tender_proposal_no"
                                               class="form-control form-control-sm"
                                               value="{{old('tender_proposal_no',isset($data['insertedData']) ? $data['insertedData']->tender_proposal_no  : '')}}"
                                               type="text"
                                               id="tender_proposal_no"
                                               maxlength="50">
                                    </div>
                                    <label for="tender_proposal_date_field"
                                           class="col-sm-1 col-form-label pr-0 pl-0 ">Date</label>
                                    <div class="input-group date tender_proposal_date col-sm-3"
                                        ...
                                        <input type="text" autocomplete="off" onkeydown="return false"
                                               ...
                                               data-toggle="datetimepicker"
                                               value="{{ old('tender_proposal_date', isset($data['insertedData']) ? \App\Helpers\HelperClass::dateConvert($data['insertedData']->tender_proposal_date)  : '') }}"
                                               data-predefined-date="{{ old('tender_proposal_date', isset($data['insertedData']) ? \App\Helpers\HelperClass::dateConvert($data['insertedData']->tender_proposal_date)  : '') }}"
                                               placeholder="DD-MM-YYYY">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row" style="margin-bottom:8px">
                                    <label for="tender_proposal_ref" class="col-form-label col-sm-4">Tender/Prop.
                                        Ref</label>
                                    <div class="col-sm-8">
                                        <input name="tender_proposal_ref"
                                               class="form-control form-control-sm"
                                               value="{{old('tender_proposal_ref',isset($data['insertedData']) ? $data['insertedData']->tender_proposal_ref  : '')}}"
                                               type="text"
                            ...
                            <div class="col-md-12">
                                <div class="form-group row" style="margin-bottom:8px">
                                    <label for="contract_no" class="col-form-label col-sm-4">Contract No</label>
                                    <div class="col-sm-4">
                                        <input name="contract_no" class="form-control form-control-sm"
                                               value="{{old('contract_no',isset($data['insertedData']) ? $data['insertedData']->contract_no  : '')}}"
                                               type="text"
                                               id="contract_no"
                                               maxlength="100">
                                    </div>
                                    <label for="contract_date_field"
                                           class="col-sm-1 pr-0 pl-0 col-form-label">Date</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group row" style="margin-bottom:8px">
                                    <label for="subject" class="col-form-label col-sm-4">Subject</label>
                                    <div class="col-sm-8">
                                        <input name="subject" tabindex="12"
                                               class="form-control form-control-sm"
                            ...
                            <div class="col-md-12">
                                <div class="form-group row" style="margin-bottom:8px">
                                    <label for="contract_value" class="col-form-label col-sm-4">Contract
                                        Value</label>
                                    <div class="col-sm-5">
                                        <input name="contract_value"
                                               class="form-control form-control-sm"
                            ...
                            <div class="col-md-12">
                                <div class="form-group row" style="margin-bottom:8px">
                                    <label for="booking_amount" class="col-form-label col-sm-4 required">Booking
                                        Amount</label>
                                    <div class="col-sm-5">
                                        ...
                                        <input required name="booking_amount" tabindex="13" autocomplete="off"
                                               class="form-control form-control-sm text-right"
                        ...
                        <div class="row">
                            <div class="col-md-8 offset-4 mb-1">
    ...
    <input type="hidden" name="mode" value="{{ old('mode',isset($mode) ? $mode : '')}}" id="mode">
    <div class="row mt-1">
        <div class="col-sm-12 d-flex">
            ...
            @if(isset($data['insertedData']))
                <a href="{{route('concurrence-transaction-list.index')}}" class="btn btn-sm btn-dark">
                    <i class="bx bx-reset font-size-small"></i><span class="align-middle ml-25">Cancel</span>
                </a>
            @else
                <button type="button" class="btn btn-sm btn-dark resetFrom">
