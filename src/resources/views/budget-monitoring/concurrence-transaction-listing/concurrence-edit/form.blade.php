        ...
        <div class="col-sm-6 pr-0">
            <fieldset class="border pl-1 pr-1" style="height: 100%">
                ...
                <div class="row" style="margin-bottom:8px">
                    ...
                    <div class="col-sm-3">
                        <select readonly required name="fiscal_year" tabindex="3"
                                class="form-control form-control-sm required make-readonly"
                                id="fiscal_year">
                            @foreach($data['financialYear'] as $year)
                                <option {{  old('fiscal_year',isset($data['insertedData']) ? $data['insertedData']->fiscal_year_id  : '') ==  $year->fiscal_year_id ? "selected" : "" }} value="{{$year->fiscal_year_id}}">{{$year->fiscal_year_name}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <select {{--readonly--}} required name="transaction_period"
                                class="form-control form-control-sm required {{--make-readonly--}}"
                ...
                <div class="form-group row ">
                    ...
                    <div
                        class="input-group date transaction_date col-sm-5"
                        id="transaction_date"
            ...
            <div class="row">
                <div class="col-md-12 pr-0">
                    <fieldset class="border pl-1 pr-1">
                        ...
                        <div class="form-group row make-select2-readonly-bg" style="margin-bottom:8px">
                        ...
                        <div class="form-group row" style="margin-bottom:8px">
                            ...
                            <div class="col-sm-4">
                                <input readonly name="budget_head_id" class="form-control form-control-sm make-readonly-bg"
                            ...
                            <div class="col-sm-4">
                                <button disabled class="btn btn-sm btn-primary searchBudget make-readonly" id="search_budget"
                                        type="button"
            ...
            <div class="row">
                <div class="col-md-12 pr-0">
                    <fieldset class="border pl-2 pr-1">
                        ...
                        <div class="form-group row" style="margin-bottom:8px">
                            <label for="remarks" class="required col-sm-2 col-form-label pl-0">Remarks</label>
                            <div class="col-sm-10">
                    <textarea required maxlength="500" name="remarks" class="required form-control form-control-sm "
                                ...
                                <div class="form-group row" style="margin-bottom:8px">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control form-control-sm"
                                               id="vendor_name"
                                               value="{{ old('vendor_name', isset($data['insertedData']) ?  $data['insertedData']->vendor_name : '') }}"
...
--}}
                        ...
                        <div class="row">
                            <div class="col-md-9 offset-3 mb-1">
                                <textarea readonly class="form-control form-control-sm pl-1" rows="2" id="booking_amount_word"
                                          tabindex="-1"></textarea>
                            </div>
                        </div>
                    </fieldset>
    ...
    <div class="row mt-1">
        <div class="col-sm-12 d-flex">
            ...
            @else
                <button type="reset" class="btn btn-sm btn-dark resetFrom" onclick="resetField(['#department','#tender_proposal_type'])">
