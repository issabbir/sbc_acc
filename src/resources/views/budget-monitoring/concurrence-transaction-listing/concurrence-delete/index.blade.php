...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            @include('budget-monitoring.concurrence-transaction-listing.concurrence-delete.form')
        </div>
    </div>
        ...
        $("#concurrence_form").on("submit", function (e) {
            ...
            swal.fire({
                ...
                if (result.value == true) {
                    ...
                    $('<input type="hidden" name="mode" value="{{\Illuminate\Support\Facades\Crypt::encryptString('D')}}">').appendTo('#concurrence_form');
