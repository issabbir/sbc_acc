        ...
        <div class="col-sm-6 pr-0">
            <fieldset class="border pl-1 pr-1" style="height: 100%">
                ...
                <div class="form-group row ">
                    ...
                    <div
                        class="input-group date transaction_date col-sm-5 make-readonly"
                        id="transaction_date"
                        data-target-input="nearest">
                        <input required type="text" autocomplete="off" onkeydown="return false"
                               name="transaction_date" tabindex="4" readonly
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group date document_date col-md-5 make-readonly mb-1"
                         id="document_date"
                         data-target-input="nearest">
                ...
                <div class="form-group row" style="margin-bottom:8px">
                    ...
                    <div class="col-sm-9">
                        <input style="background-color: yellow" maxlength="100" name="document_no" type="text" tabindex="6" required readonly
                ...
                <div class="form-group row" style="margin-bottom:8px">
                    ...
                    <div class="col-sm-5">
                        <input readonly tabindex="-1" name="ministry_approved"
                               ...
                               value="{{ $data['insertedData']->budget_approved_amt }}"
                               type="text"
                ...
                <div class="form-group row" style="margin-bottom:8px">
                    ...
                    <div class="col-sm-5">
                        <input style="background-color: yellow" readonly tabindex="-1" name="utilized_amount"
                               class="form-control form-control-sm text-right-align"
                               value="{{ $data['insertedData']->budget_utilized_amt }}"
                               type="text"
                               id="utilized_amount">
                    </div>
                </div>
                <div class="form-group row" style="margin-bottom:8px">
                    ...
                    <div class="col-sm-5">
                        <input style="background-color: yellow" readonly tabindex="-1" name="balance_amount"
                               class="form-control form-control-sm text-right-align"
                               value="{{ $data['insertedData']->budget_balance_amt }}"
                               type="text"
                               id="balance_amount">
                    </div>
                </div>
                ...
                <div class="col-md-12 pr-0">
                    <fieldset class="border pl-1 pr-1">
                        ...
                        <div class="form-group row" style="margin-bottom:8px">
                            ...
                            <div class="col-sm-9">
                                <input style="background-color: yellow" readonly tabindex="-1" name="budget_head_name"
                        ...
                        <div class="form-group row" style="margin-bottom:8px">
                            ...
                            <div class="col-sm-9">
                                <input style="background-color: yellow" readonly tabindex="-1" name="budget_type" class="form-control form-control-sm"
                ...
                <div class="col-md-12 pr-0">
                    <fieldset class="border pl-2 pr-1">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row" style="margin-bottom:8px">
                                    ...
                                    <div class="col-sm-7 pl-0 pr-0">
                                        <input style="background-color: yellow" maxlength="20" name="est_amount" tabindex="-1" autocomplete="off"
                                               type="text" readonly
                        ...
                        <div class="form-group row" style="margin-bottom:8px">
                            ...
                            <div class="col-sm-10">
                    <textarea maxlength="500" name="remarks" class="required form-control form-control-sm " required
                    ...
                    <fieldset class="border pl-1 pr-1">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row" style="margin-bottom:8px">
                                    ...
                                    <div class="col-sm-4 pr-0">
                                        ...
                                        <input style="background-color: yellow" required name="booking_amount" tabindex="13" autocomplete="off" readonly
                                               class="form-control form-control-sm text-right"
                        ...
                        <div class="row">
                            <div class="col-md-9 offset-3 mb-1">
                                <textarea style="background-color: yellow" readonly class="form-control form-control-sm pl-1" rows="2"
    ...
    <div class="row mt-1">
        <div class="col-sm-12 d-flex">
            <button type="submit" tabindex="14"
                    class="btn btn-sm btn-warning mr-1" id="budgetFormSubmit"><i
                    class="bx bx-trash font-size-small"></i><span class="align-middle ml-25">
                    Delete</span>
            </button>
