                                ...
                                if (res.response_code == "1") {
                                    Swal.fire({
                                        ...
                                        if (action_type == "{{ App\Enums\ActionType::SAVE}}") {
                                            ...
                                            //Sujon-CR
                                            $('#print_btn').html('<a target="_blank" href="{{request()->root()}}/report/render/TRANSACTION_LIST_CASH_CHEQUE_WISE?xdo=/~weblogic/FAS_NEW/ACCOUNTS_PAYABLE/RPT_AP_TRANSACTION_LIST_BATCH_ACCOUNT_CASH_WISE.xdo&p_posting_period_id=' + res.period + '&p_trans_batch_id=' + res.batch + '&type=pdf&filename=transaction_list_cash_cheque_wise" class="cursor-pointer btn btn-info mr-1"><i class="bx bx-printer"></i><span class="align-middle ml-25">Trans Print</span></a>');
