                                        ...
                                        <div class="col-md-3">
                                            <div class=" form-group row">
                                                <label for="acc_type" class="col-md-5 col-form-label">Account
                                                    Type</label>
                                                <select class="form-control form-control-sm col-md-7 make-readonly-bg" name="acc_type" id="acc_type">
                                                    @foreach($coaParams as $type)
                                                        <option {{ ($type->gl_type_id == \App\Enums\Common\GlCoaParams::ASSET) ? 'selected' : '' }} value="{{$type->gl_type_id}}">{{$type->gl_type_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
