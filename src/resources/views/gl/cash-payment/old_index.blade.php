        ...
        $(document).ready(function () {
            ...
            * */
            ...
            resetCreditAccountField = function () {
                ...
                resetField(['#c_account_balance', '#c_authorized_balance', '#c_currency', '#c_amount_ccy', '#c_amount_lcy', '#c_exchange_rate']);
            }
            ...
            $("#searchAccount").on("click", function () {
                ...
                if ($accId != "") {
                    ...
                    //Add IF & ELSE CONDITION :PAVEL-11-04-22
