<form id="cash_payment_form" action="#" method="post" enctype="multipart/form-data">
        ...
        <fieldset class="border p-2 col-md-12">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 pl-0 pr-0">
                    <select class="form-control form-control-sm" id="c_bank_account" name="c_bank_account" required>
                    </select>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <input class="form-control form-control-sm col-md-4 text-right-align" id="c_amount_ccy" name="c_amount_ccy" maxlength="17" oninput="maxLengthValid(this)" min="0" step="0.01"
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <input class="form-control form-control-sm col-md-4 text-right-align" id="d_amount_ccy" name="d_amount_ccy" maxlength="17" oninput="maxLengthValid(this)" min="0" step="0.01"
                               type="number">
                    </div>
                </div>
            </div>
    ...
    <div class="row mt-1">
        <div class="col-md-12 d-flex">
            ...
            <button type="reset" class="btn btn-sm btn-dark" onclick="resetTablesDynamicRow();resetCreditAccountField();resetHeaderField();removeAllAttachments()"><i class="bx bx-reset font-size-small"></i><span class="align-middle ml-25">Reset</span></button>
