...
--}}
        ...
        <div class="col-md-6">
            ...
            <div class="form-group row justify-content-end make-readonly">
                ...
                <div class="col-md-5">
                    <select required name="bill_section"  class="form-control form-control-sm" readonly="" id="bill_section">
                    </select>
                </div>
            </div>--}}
            <div class="form-group row d-flex justify-content-end">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <input class="required form-control form-control-sm col-md-4 text-right-align" id="c_amount_ccy"
                               maxlength="17"
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <input required class="form-control form-control-sm col-md-4 text-right-align" readonly id="d_amount_ccy" maxlength="17" oninput="maxLengthValid(this)"
    ...
    <div class="row mt-1">
        <div class="col-md-12 d-flex">
            ...
            <button type="button" id="reset_form" class="btn btn-sm btn-dark"><i class="bx bx-reset font-size-small"></i><span class="align-middle ml-25">Reset</span></button>
