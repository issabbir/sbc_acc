                        ...
                        <div class="form-body {{--row d-flex justify-content-center--}}">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-10" >
                                    <input maxlength="200" type="text" id="head_name"
                                           ...
                                           value="{{old('head_name',isset($headInfo->budget_head_name) ? $headInfo->budget_head_name : '')}}" style="background: #e7f578"/>
                                </div>
                            </div>
                            <div class="row mb-1">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-2">
                                    <button type="button" class="btn btn-info btn-sm btn-block make-readonly-bg"
                                            id="search_parent_head" @if(isset($headInfo->budget_parent_id)) disabled @endif >
                            ...
                            <fieldset class="border pl-1 pr-1">
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div
                                        class="col-md-6 pl-0 make-select2-readonly-bg">
                                        <select class="form-control form-control-sm select2 make-select2-readonly-bg "
                                                name="department_id"
                                                id="department_id">
                                            <option value="">&lt;Select&gt;</option>
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-md-6 pl-0">
                                        <input type="text" id="selected_parent_acc_name"
                                               class="form-control form-control-sm make-readonly" name="parent_acc_name"
        ...
        $("#budget_head_setup").on("submit", function (e) {
            ...
            swal.fire({
                ...
                preConfirm: (data) => {
                    ...
                    return $.ajax({
                        url: APP_URL + "/budget-management/budget-head-setup/" + id,
