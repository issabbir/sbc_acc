    ...
    <div class="card">
        <div class="card-body">
            <div class="card-header d-flex justify-content-between align-items-center p-0">
                ...
                <a href="{{route('invoice-bill-payment-list.index',['filter'=>(isset($filter) ? $filter : '')])}}"><span class="badge badge-primary font-small-4"><i
            ...
            <form id="invoice-bill-pay-form" enctype="multipart/form-data"
                ...
                <fieldset class="border p-2 mt-2">
                    ...
                    @endif
                    {{-- TODO: Add this section- start : Pavel-09-05-22 --}}
                    <h6><span class="border-bottom-secondary border-bottom-1 text-bold-600">Payment Information</span></h6>
                    <div class="row">
                    ...
                    <div class="viewDocumentRef row">
                        ...
                        <div class="col-md-10 form-group pl-0">
                            <textarea class="form-control form-control-sm" id="favoring" name="favoring" rows="2" placeholder="" maxlength="500" disabled>{{isset($invBillPayInfo->favoring) ? $invBillPayInfo->favoring : ''}}</textarea>
                        </div>
                    </div>

                    <div class="editDocumentRef row d-none">
                        <div class="col-md-2"><label for="edt_favoring" class="required">Favoring </label></div>
                        <div class="col-md-10 form-group pl-0">
                            <textarea class="form-control form-control-sm" id="edt_favoring" name="edt_favoring" rows="2" placeholder="" maxlength="500" >{{ $invBillPayInfo->favoring }}</textarea>
                        </div>
                    </div>
