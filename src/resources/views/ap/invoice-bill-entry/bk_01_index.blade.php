    ...
    <script type="text/javascript">
        ...
        * */
        $(" #ap_vendor_search").on("click", function () {
            ...
            $('#ap_switch_pay_vendor_search').val('{{\App\Enums\YesNoFlag::NO}}');
        ...
        * */
        ...
        $(document).on('click', '.vendorSelect', function () {
            ...
            } else if (($('#ap_add_vendor_search').val()) == '{{\App\Enums\YesNoFlag::YES}}') {  //Add -Pavel: 07-07-22
        ...
        * */
        ...
        function enableDisableTaxVatFieldOnInclusive(inclusive_status) {
            ...
            if ((taxVatCalcCheckStatus == false)) {
                if (inclusive_status == true) {
                    ...
                    $("#party_name_for_tax").val('').addClass("make-readonly-bg");
                    $("#party_name_for_vat").val('').addClass("make-readonly-bg");
                } else {
                    $("#ap_tax_amount_ccy_percentage").attr("readonly", "readonly");
                    $("#ap_vat_amount_ccy_percentage").attr("readonly", "readonly");
        ...
        function setAddVendorInfo(d) {
            if ($.isEmptyObject(d.party_info)) {
                ...
                $('#ap_add_account_balance').val(d.party_info.account_balance);
                $('#ap_add_authorized_balance').val(d.party_info.authorized_balance);
            }
        }
                ...
                request.done(function (d) {
                    if ($.isEmptyObject(d.party_info)) {
                        ...
                        if (forAdd){
                            ...
                            $('#ar_dist_account_balance').val(d.party_info.account_balance);
                            $('#ar_dist_authorized_balance').val(d.party_info.authorized_balance);
                        }
        ...
        $(document).on('change', '#ap_invoice_type', function () {
            ...
            if (!nullEmptyUndefinedChecked($(this).find(':selected').val())) {
                ...
                /*** Add this section start Pavel: 23-03-22 ***/
                if ($(this).val() == {{\App\Enums\Ap\LApInvoiceType::SWC_ADJ_PRO_CON_SUPP}}) {
        ...
        function setAccountInfo(d) {
            if ($.isEmptyObject(d.bankAccountInfo)) {
                ...
                $("#ap_account_balance").val(d.bankAccountInfo.account_balance);
                $("#ap_authorized_balance").val(d.bankAccountInfo.authorize_balance);
                ...
                if (fieldsAreSet(['#ap_amount_ccy', '#ap_account_id', '#ap_account_name', '#ap_amount_lcy'])) {
                    if ($(selector).attr('data-type') == 'A') {
                        ...
                        let html = '<tr>\n' +
                            ...
                            '</td>\n' +
                            '<td><input name="" value="' + partyId + '" class="form-control form-control-sm" id="ap_dist_vendor_id_view' + count + '" readonly></td>' +
                            '<td><input name="" value="' + partyName + '" class="form-control form-control-sm" id="ap_dist_vendor_name_view' + count + '" readonly></td>' +
                ...
                if (!nullEmptyUndefinedChecked(d.bankAccountInfo.module_id)) {
                    if (d.bankAccountInfo.module_id == '{{\App\Enums\Common\LGlInteModules::ACC_PAY_VENDOR}}') {
                        ...
                        if (!nullEmptyUndefinedChecked($("#ap_dist_vendor_id" + line).val())) {
                            ...
                            $("#ap_dist_account_balance").val($("#account_balance" + line).val());
                            $("#ap_dist_authorized_balance").val($("#authorized_balance" + line).val());
                        }
                        ...
                        if (!nullEmptyUndefinedChecked($("#ap_dist_vendor_id" + line).val())) {
                            ...
                            $("#ar_dist_account_balance").val($("#account_balance" + line).val());
                            $("#ar_dist_authorized_balance").val($("#authorized_balance" + line).val());
                        }
        ...
        function setDistVendorInfo(d) {
            if ($.isEmptyObject(d.party_info)) {
                ...
                $('#ap_dist_account_balance').val(d.party_info.account_balance);
                $('#ap_dist_authorized_balance').val(d.party_info.authorized_balance);
            }
        }
        ...
        $(document).ready(function () {
            ...
            * */
            ...
            $("#reset_form").on('click', function () {
                ...
                $("#ap_party_sub_ledger").val('').trigger('change');
