                    ...
                    <div class="col-md-6">
                        <select required name="cost_center" class="form-control form-control-sm select2" id="cost_center">
                            ...
                            @foreach($costCenter as $center)
                                <option
                                    {{  old('cost_center') ==  $center->cost_center_id ? "selected" : "" }} value="{{$center->cost_center_id}}"> {{ $center->cost_center_name}} </option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group row justify-content-end hidden">
                    <label for="budget_department" class="col-form-label col-md-4 required ">Budget Department</label>
                    <div class="col-md-6">
                        <select name="budget_department" class="form-control form-control-sm select2"
                                id="budget_department">
                            <option value="">&lt;Select&gt;</option>
                            @foreach($costCenter as $center)
                                <option
                                    {{  old('budget_department') ==  $center->cost_center_id ? "selected" : "" }} value="{{$center->cost_center_id}}"> {{ $center->cost_center_name}} </option>
                            @endforeach
                        </select>
                    </div>
                </div>
