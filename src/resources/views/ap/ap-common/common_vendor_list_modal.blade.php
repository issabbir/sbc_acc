                            ...
                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 d-flex justify-content-end">
                                                        <button type="submit" class="btn btn-sm btn-primary mb-1"
                                                                id="ap_vendor_search_submit">
                                                            <i class="bx bx-search font-size-small align-middle"></i>
                                                            <span class="align-middle">Search</span>
                                                        </button>
                                                        {{--<button type="reset" class="btn btn-sm btn-dark mb-1 ml-25"
                                                                id="ap_vendor_search_reset">
                                                            <i class="bx bx-reset font-size-small align-middle"></i>
                                ...
                                <div class="shadow-none">
                                    <div class="table-responsive">
                                        <table class="table table-sm table-bordered table-hover" style="width: 100% !important;" id="vendorSearch">
