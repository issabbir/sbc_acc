...
class FdrOpeningAuthorizeController
{
    ...
    public function view($id,$filter,$wkmId)
    {
        ...
        $this->transactionView = DB::selectOne("select * from sbcacc.glGetTransactionView(:p_gl_trans_master_id)", ['p_gl_trans_master_id' => $id]) ?? [];
    ...
    public function perform(Request $request)
    {
        ...
        DB::beginTransaction();
        $params = [
            'i_workflow_mapping_id' => (int)$request->post('wkMapId'),
    ...
    public function dataList(Request $request)
    {
        ...
        $opening_list = DB::select('select * from sbcacc.FdrOpeningTransAuthList(:p_investment_type_id,:p_fiscal_year_id,:p_posting_period_id,:p_workflow_approval_status, :p_user_id)',
