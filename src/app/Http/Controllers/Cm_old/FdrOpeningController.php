...
class FdrOpeningController extends Controller
{
    ...
    public function index($id = null)
    {
        ...
        if (isset($id)) {
            ...
            $this->transactionView = DB::selectOne("select * from SBCACC.glGetTransactionMasterView(:p_gl_trans_master_id)", ['p_gl_trans_master_id' => $this->openingInfo->investment_contra_gl_id])?? [];
        }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::executeProcedure('sbc_dev.fas_cm_trans.fas_fdr_opening_trans_make', $params);
