...
class ClearingReconciliationAuthorizeController extends Controller
{
    ...
    public function searchClearingReconciliationAuthorize(Request $request)
    {
        ...
        $data = DB::select("select sbcacc.fas_cm_trans.get_clearing_recon_auth_list(:p_period,:p_function_id,:p_bank_account_id,:p_workflow_approval_status,:p_user_id) from dual",
