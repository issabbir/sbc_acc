...
class FdrIntProvisionProcessController extends Controller
{
    ...
    public function editView(Request $request, $id)
    {
        ...
        $intProvTransViewList = DB::select("select * from table (sbc_dev.fas_cm_trans.get_fdr_provision_trans_preview(:p_investment_type_id,:p_fiscal_year_id))",[ 'p_investment_type_id' =>$invTypeId, 'p_fiscal_year_id' => $fiscalYearId ]);
    ...
    public function dataTableList(Request $request)
    {
        ...
        $sql ="select sbcacc.fas_cm_trans.get_fdr_provision_process_make_list (:p_investment_type_id) from dual";
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::executeProcedure('sbcacc.fas_cm_trans$fas_fdr_provision_process_make', $params);
