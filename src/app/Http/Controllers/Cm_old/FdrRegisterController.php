...
class FdrRegisterController extends Controller
{
    ...
    public function index($param = null)
    {
        ...
        $investmentInfo = isset($param) ? (DB::selectOne('select sbcacc.fas_cm_config.get_fdr_investment_make_view (:p_investment_id) from dual',['p_investment_id'=>$mode[0]])) : null;
    ...
    public function store(Request $request, $id = null)
    {
        ...
        try {
            $params = [
                ...
                'p_term_period_days' => $request->post('term_period_days'),
            ...
            DB::executeProcedure('sbcacc.fas_cm_config$fas_fdr_register_save', $params);
    ...
    public function dataTableList(Request $request)
    {
        ...
        return datatables()->of($investment_list)
            ->editColumn('investment_date',function ($d){
                ...
                return HelperClass::dateFormatForDB($d->exp_date);
                ...
                $edit = '';
                if ($d->workflow_approval_status != "P" ){
