...
class ClearingReconciliationList extends Controller
{
    ...
    public function dataList(Request $request)
    {
        ...
        //$data = DB::select("select sbcacc.fas_cm_trans.get_clearing_recon_make_list(:p_period,:p_function_id,:p_bank_account_id,:p_workflow_approval_status) from dual",["p_period"=>$period,"p_function_id"=>$functionType, "p_bank_account_id" => $bank,"p_workflow_approval_status"=>$approvalStatus]);

        $data = DB::select('select * from sbcacc.cmClearingReconMakeList(:p_period,:p_function_id,:p_bank_account_id,:p_workflow_approval_status)',["p_period"=>$period,"p_function_id"=>$functionType, "p_bank_account_id" => $bank,"p_workflow_approval_status"=>$approvalStatus]);
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            DB::executeProcedure('sbcacc.fas_cm_trans$clearing_reconciliation_update', $params);
