...
class FdrInvRegAuthorizeController extends Controller
{
    ...
    public function approvalView(Request $request, $id, $filter=null)
    {
        ...
        $fdrInvInfo = DB::selectOne("select sbcacc.fas_cm_config.get_fdr_investment_auth_view (:p_investment_auth_log_id) from dual",['p_investment_auth_log_id' => $id]);
    ...
    public function searchFdrInvRegAuthorize(Request $request)
    {
        ...
        $sql ="select sbcacc.fas_cm_config.get_fdr_investment_auth_list (:p_investment_type_id,:p_bank_code,:p_branch_code,:p_action_type,:p_workflow_approval_status,:p_user_id) from dual";
