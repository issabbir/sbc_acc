...
class CashPaymentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('gl.cash-payment.index', compact('isRequired','coaParams', 'customerCategory', 'vendorCategory', 'vendorType', 'fiscalYear', 'costCenter', 'funcType', 'billSecs', 'lastGlTranMst'));
    }
                    ...
                    if ($dtlCreditParams['o_status_code'] == "99") {
                        ...
                        foreach ($request->post("line") as $key => $line) {
                            if ($line['action_type'] == "A") {
                                ...
                                DB::executeProcedure('sbcacc.GL_TRANS_DETAIL_MAKE', ${"dtlDebitParams.$key"});
