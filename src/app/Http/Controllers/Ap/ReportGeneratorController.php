...
class ReportGeneratorController extends Controller
{
    ...
    public function reportParams($id)
    {
        ...
        $subsidiary_type = DB::select("select sbcacc.fas_report.get_gl_subsidiary_name(" . LGlInteModules::ACC_PAY_VENDOR . ") from dual");
        ...
        return view('ap.reportgenerator.report-params', compact('users', 'fiscalYear', 'modules', 'oldFiscalYear', 'apFuncType', 'vendors', 'subsidiary_type', 'closingEvents', 'department', 'billSecs','billRegister', 'report'))->render();
    }
}
