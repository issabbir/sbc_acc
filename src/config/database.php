    ...
    */
    ...
    'connections' => [
        ...
        'sqlsrv_pmis' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_PMIS', 'localhost'),
            'port' => env('DB_PORT_PMIS', '1433'),
            'database' => env('DB_DATABASE_PMIS', 'forge'),
            'username' => env('DB_USERNAME_PMIS', 'forge'),
            'password' => env('DB_PASSWORD_PMIS', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            'encrypt' => 'yes', // alternatively, defer to an env variable
